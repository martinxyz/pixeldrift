...
w.set_cell_types([
    ...
    #        |  |  + child1_maxcount
    #        |  |  |
    CellType(0, 0, 255),  # 0: empty
    CellType(1, 2, 255),  # 1: stem cell
    CellType(2, 3, 7),    # 2: progenitor cell
    CellType(3, 0, 15),   # 3: differentiated cell (child1_maxcount = max move dist)
])
